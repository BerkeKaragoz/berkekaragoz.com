...
export const placeholderWhitePixelBlurBase64 =
   "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAA1JREFUGFdj+Pf/338ACfUD+5LbVnEAAAAASUVORK5CYII="

export const BINANCE_API_HOST = "https://api.binance.com/api/v3"

export const PLATFORM_GITHUB_LINK = "https://github.com/BerkeKaragoz"
