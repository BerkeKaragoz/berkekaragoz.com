          ...
          <div className="p-3 card">
            ...
            >
              <Trans t={t} i18nKey="index.experience.havelsanDesc">
                <p>
                  Developed policies and tools for Liman MYS (a configuration
                  management and software provisioning tool) and GNU/Linux
                  systems focused on Debian using C and Shell Scripting.
                </p>
                <p className="mt-2">
                  {"Developed "}
            ...
            >
              <Trans t={t} i18nKey="index.experience.datamarketDesc">
                ...
                Trainings can be created via the admin panel on desktop and can
                be synchronized with all devices with support. Transactions were
            ...
            >
              <Trans t={t} i18nKey="index.experience.anchaDesc">
                <p>
                  ...
                  motors to compete in European Rover Challenge. The components
                  were designed to endure extreme conditions of Mars and space.
                  The primary design program was Autodesk Inventor.
                </p>
                <p className="mt-2">
                  Ancha Space Technologies is an interdisciplinary organization
                  that their headquarters are located on Istanbul Başakşehir
                  Living Lab. The team competes in space technology related
                  challenges.
                </p>
              </Trans>
            </ExpPanel>
