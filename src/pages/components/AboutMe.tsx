      ...
      <div className="flex flex-col items-center lg:flex-row-reverse">
        ...
        <article className="p-4 mt-8 xs:text-justify lg:mt-0 lg:mr-8 max-w-prose card dark:bg-background-900">
          <Trans t={t} i18nKey="index.aboutMe.article">
            ...
            <p className="mt-2 indent-xs">
              As for the hobbies, competitive gaming is one of my biggest ones.
              I play the chess of FPS, Quake, actively. In addition to this, I
              had been playing Counter-Strike and more others. After, I have
              been working as a tournament manager.
            </p>
          </Trans>
        </article>
      </div>
