...
const HeroWidget: React.FC<Props> = (props) => {
   ...
   return (
      <div className="hidden xs:block md:w-1/2">
         ...
         <div className="flex h-full min-w-full p-4 overflow-y-auto bg-opacity-50 md:block md:w-max column md:p-8 rounded-t-xl md:rounded-t-none rounded-b-xl bg-primary-100 dark:bg-background-900">
