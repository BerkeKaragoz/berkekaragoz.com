...
const assetNames = [
   "berke-green.jpg",
   "berke-with-camera.jpg",
   "berke-with-turkish-coffee.jpg",
]
const assetBlurs = [
   "data:image/jpeg;base64,/9j/4AAinitialOneIsNotNeededlwT//Z",
   "data:image/webp;base64,",
