...
I joined pnpm's Discord server: [r.pnpm.io/chat](https://r.pnpm.io/chat). Turns out there already was an issue related to that and they have patched this problem in less than 24 hours.
