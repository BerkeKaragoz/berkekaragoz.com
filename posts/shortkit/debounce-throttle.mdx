...
commentTerm: p/readme-shortkit-debounce-throttle
---
...
<Image
   priority
   src="/assets/posts/shortkit/cover.png"
   alt="Strategies for rate-limiting - x.com@itsalexzajac 7:30 AM · Dec 17, 2024"
   width={773}
   height={1000}
   quality={100}
   placeholder="blur"
